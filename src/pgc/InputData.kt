 ...
 */
class InputData(limitText: String, radiusText: String, densityText: String, stepText: String) {
  ...
  data class Parameters(val limit: Int, val radius: Long, val steps: Long, val density: Double)
